...
SCRIPT_DESCRIPTION = r"""
 ...
 ______      ___   ______   ______  ____  ____     ______  _______      ___   _____  _____  _______   
|_   _ `.  .'   `.|_   _ \ |_   _ \|_  _||_  _|  .' ___  ||_   __ \   .'   `.|_   _||_   _||_   __ \  
  | | `. \/  .-.  \ | |_) |  | |_) | \ \  / /   / .'   \_|  | |__) | /  .-.  \ | |    | |    | |__) | 
  | |  | || |   | | |  __'.  |  __'.  \ \/ /    | |   ____  |  __ /  | |   | | | '    ' |    |  ___/  
 _| |_.' /\  `-'  /_| |__) |_| |__) | _|  |_    \ `.___]  |_| |  \ \_\  `-'  /  \ \__/ /    _| |_     
|______.'  `.___.'|_______/|_______/ |______|    `._____.'|____| |___|`.___.'    `.__.'    |_____|                            
By: Dobby
---------------------------------------
This script searcimport datetime
import os
import pickle
import json
import re
...
hes messages containing specified search terms in Telegram channels the user is a member of.
It exports the search results in HTML and CSV formats, generates a report, and plots the message count per day."""
